...
#undef  VECTOR_014
#undef  VECTOR_015
#if     UCOS_EN > 0u    //如果定义了用ucos系统  用ucos的滴答定时器中断服务函数
...
#undef  VECTOR_016
#define VECTOR_016    DMA_CH0_Handler  //DMA通道0中断
...
#undef  VECTOR_078
#define VECTOR_078    FTM0_IRQHandler   //FTM0 输入捕捉中断

#undef  VECTOR_084
#define VECTOR_084    PIT0_IRQHandler  //PIT0_IRQHandler 中断

#undef  VECTOR_085
#define VECTOR_085    PIT1_IRQHandler  //PIT1_IRQHandler 中断

#undef  VECTOR_101
#define VECTOR_101    LPT_Handler   //脉冲计数器中断
