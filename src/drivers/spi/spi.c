...
void spi_init(SPIn spin,SPI_CFG master)
{
    ...
    else if(spin == 1)
    {
        ...
        /*
        PORTE_PCR1 = 0 | PORT_PCR_MUX(0x2) | PORT_PCR_DSE_MASK; //MOSI
        PORTE_PCR2 = 0 | PORT_PCR_MUX(0x2) | PORT_PCR_DSE_MASK; //SCK
        PORTE_PCR3 = 0 | PORT_PCR_MUX(0x2);                     //MISO
        PORTE_PCR4 = 0 | PORT_PCR_MUX(0x2) | PORT_PCR_DSE_MASK; //PCS0
        */
        PORTB_PCR16 = 0 | PORT_PCR_MUX(0x2) | PORT_PCR_DSE_MASK; //MOSI
        PORTB_PCR11 = 0 | PORT_PCR_MUX(0x2) | PORT_PCR_DSE_MASK; //SCK
        PORTB_PCR17 = 0 | PORT_PCR_MUX(0x2);                     //MISO
